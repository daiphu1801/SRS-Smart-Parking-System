...
class _CustomerDetailScreenState extends State<CustomerDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<CustomerViewModel>().fetchCustomer(widget.customerId);
    });
  }
    ...
    return Scaffold(
      ...
      body: Consumer<CustomerViewModel>(
        builder: (context, viewModel, child) {
          final state = viewModel.customerState;
                  ...
                  AppCard(
                    child: Column(
                      ...
                      children: [
                        ...
                        Divider(height: 24, color: AppTheme.border),
                        InfoRow(label: 'Số CMND/CCCD', value: customer.identityNumber),
                        Divider(height: 24, color: AppTheme.border),
