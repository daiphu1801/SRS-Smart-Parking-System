...
class _ParkingSessionDetailScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ParkingSessionViewModel>().fetchSessionById(
        widget.sessionId,
      );
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(
        leading: context.canPop()
            ...
            : null,
        title: Text(l10n.parkingSessionDetail),
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Ảnh Camera LPR ───────────────────────────────────────────────
          Text(l10n.lprCameraImage, style: AppTheme.heading3),
          ...
          DetailInfoCard(
            ...
            items: [
              ...
              DetailRowItem(
                ...
                value: session.vehicleType == 'CAR' ? l10n.car : l10n.motorbike,
              ),
              if (session.bookingDetailId != null)
                DetailRowItem(
                  icon: Icons.card_membership_outlined,
                  label: l10n.packageCode,
              ...
              if (session.flagManual)
                DetailRowItem(
                  ...
                  value: l10n.manualGateOpen,
                  valueStyle: AppTheme.body.copyWith(
          ...
          DetailInfoCard(
            ...
            items: [
              ...
              DetailRowItem(
                ...
                label: l10n.gateOut,
                value: session.zoneOutName ?? l10n.notExitedYet,
              ),
            ],
          ),
          ...
          DetailInfoCard(
            ...
            items: [
              ...
              DetailRowItem(
                ...
                label: l10n.exitTime,
                value: session.exitTime != null
                    ? dateFormatter.format(session.exitTime!)
                    : l10n.vehicleNotExited,
              ),
              DetailRowItem(
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Text(
                isOngoing ? l10n.filterOngoing : l10n.filterCompleted,
              ...
              Text(
                l10n.complaintCodeLabel(session.id),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.gracePeriodRemaining(mins, secs),
                  style: AppTheme.bodySmall.copyWith(
                    color: Colors.orange.shade700,
                  ),
                ),
...
class _LprImageRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
          child: _LprImageBox(url: session.imageInUrl, label: l10n.timeIn),
        ),
        const SizedBox(width: 12),
        Expanded(
          child: _LprImageBox(
