                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isCar ? Colors.blue.shade50 : Colors.teal.shade50,
                                  shape: BoxShape.circle,
                                ),
                                child: Icon(
                                  isCar ? Icons.directions_car : Icons.two_wheeler,
                                  size: 18,
                                  color: isCar ? Colors.blue.shade700 : Colors.teal.shade700,
                                ),
                              ),
  ...
  Widget _buildRow(IconData icon, String label, String value) {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(value,
              style: AppTheme.bodySmall.copyWith(fontWeight: FontWeight.w600), textAlign: TextAlign.right),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Vui lòng lấy xe trong: ${mins}ph ${secs}s',
              style: AppTheme.bodySmall.copyWith(color: Colors.orange.shade700, fontWeight: FontWeight.w600),
            ),
          ),
        ],
      ),
