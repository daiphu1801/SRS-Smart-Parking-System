...
import com.smartparking.shared.security.filter.RateLimitFilter;
import com.smartparking.shared.security.filter.SupabaseAccountFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/api/v1/system/payments/session",    // Kiosk App tạo session (Không cần đăng nhập)
