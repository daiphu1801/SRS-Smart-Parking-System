...
public class TariffRule {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "day_type") private DayType dayType;
    @Column(name = "start_time") private LocalTime startTime;
    @Column(name = "end_time") private LocalTime endTime;
    @Column(name = "base_block_mins") private Integer baseBlockMins;
    @Column(name = "base_price", precision = 15, scale = 2) private BigDecimal basePrice;
    @Column(name = "next_block_mins") private Integer nextBlockMins;
    @Column(name = "next_block_price", precision = 15, scale = 2) private BigDecimal nextBlockPrice;
    @Column(name = "max_price_per_day", precision = 15, scale = 2) private BigDecimal maxPricePerDay;
